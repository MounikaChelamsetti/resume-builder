...
const Features = () => {
   ...
   return (
         <div
  id="features"
  className="flex flex-col items-center my-14 scroll-mt-12 text-center"
>
  {/* Badge */}
  <div className="inline-flex items-center gap-2 text-sm text-purple-800 bg-purple-500/10 rounded-full px-4 py-1.5">
    <Zap size={14} />
